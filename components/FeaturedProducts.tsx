...
//                                         %{Math.round(product.discount * 100)} İNDİRİM
//                                     </div>
//                                 )}
//                                 <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
//                                     <button className="bg-white p-2 rounded-full shadow-md hover:bg-gray-100 mx-1">❤️</button>
//                                     <button className="bg-white p-2 rounded-full shadow-md hover:bg-gray-100 mx-1">🔍</button>
//                                 </div>
//                             </div>
//                             <div className="p-4">
...
//                                         </span>
//                                     ))}
//                                     <span className="text-gray-500 text-sm ml-2">({product.num_reviews})</span>
//                                 </div>
//                                 <div className="flex items-center justify-between">
//                                     <div>
//                                         {product.discount > 0 ? (
//                                             <>
//                                                 <span className="text-xl font-bold text-indigo-600">{product.final_price.toFixed(2)} TL</span>
    ...
    return (
        <section className="py-16 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center mb-12">
                    <h2 className="text-3xl text-amber-300 font-bold">Öne Çıkan Ürünler</h2>
                    <a href='/product' className="text-indigo-600 hover:text-indigo-800 font-semibold">
                        Tüm Ürünler <span aria-hidden="true">&rarr;</span>
                    </a>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
